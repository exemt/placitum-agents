...
// Snapshot — INFO Redis, не cgroup агента. used_memory — размер хранилища.
type Snapshot struct {
	...
	// Счётчики канала `cmd`: растут монотонно, темп — их дельта между
	// опросами (redisinfo.Rate), не значение само по себе.
